...
import pytz
import pandas as pd  # Importa pandas per la conversione a datetime64[ns]
...
# Carica il messaggio dal file .pb
feed = FeedMessage()
    ...
    for entity in feed.entity:
        if entity.trip_update:
            ...
            for stop_time_update in entity.trip_update.stop_time_update:
                ...
                arrival_time = stop_time_update.arrival.time  # Questo è un float (secondi dall'epoca Unix)

                # Controlla e converte il timestamp
                if arrival_time > 0:
                    # Usa il valore in int64 per arrival_time
